        ...
        <div class="row">
            <div class="col-4" style="position:absolute;">
                <div class="list-group">
                    ...
                    <a href="admin_theatrelist.php" class="list-group-item list-group-item-action">Theatre List</a>
            ...
            <div class="col-8">
                <button type="button" class="btn btn-success" onclick="window.location='addmovieform.php';">ADD MOVIE</button>
                <button type="button" class="btn btn-success" onclick="window.location='updatemovieradio.php';">UPDATE MOVIE</button>
                <button type="button" class="btn btn-success" onclick="window.location='deletemoviecheckbox.php';">DELETE MOVIE</button><br><br>
                <ul class="list-group">
                    <?php
